Codebase for the article: "Simulation-Based Inference at the Theoretical Limit for Fast, Accurate Microstructural MRI with Minimal Diffusion Data"
...
GH data for retest analysis can be obtained upon request.

Make sure to download data and then point code to them (via imports.py).
